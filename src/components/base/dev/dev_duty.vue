        ...
        <el-table
            ...
            <el-table-column  type="expand">
                <template slot-scope="scope">
                    <el-tag size="mini"
                        v-for="(command, index) in scope.row.command_list"
                        :key="index"
                        :closable="true"
                ...
                <template slot-scope="scope">
                    <el-dropdown
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item
                                v-for="role in role_list" :key="role.roleid" :command="role.roleid">{{role.name}}</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                    <el-button type="danger"
                        size="mini"
                        plain
                        @click="delDuty(scope.row)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>

        <el-dialog title="新增职责" :visible.sync="dialogFormVisible">
