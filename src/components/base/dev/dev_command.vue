<template>
    <div>
        ...
        <el-table :data="command_list"  style="width: 100%">
            ...
            <el-table-column prop="dutyid" label="职责" width="140" align="center" :filters="filter_list" :filter-method="filterTag">
                <template slot-scope="scope">
                    <el-tag size="mini"  v-if="scope.row.dutyname" :type="tagColor[scope.row.dutyid % 5]">
                        {{scope.row.dutyname}}
                    </el-tag>
                </template>
            </el-table-column>
                ...
                <template slot-scope="scope">
                    <el-dropdown
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item
                                v-for="duty in duty_list" :key="duty.dutyid" :command="duty.dutyid">{{duty.name}}</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
        ...
        <el-dialog title="修改指令名称" :visible.sync="dialogNameFormVisible">
        ...
        <el-dialog title="新增指令" :visible.sync="dialogFormVisible">
