...
<script>
    ...
    export default {
        ...
        methods:{
            getBranchList(){
                this.$apibranch.page_list(this.pagenum, this.pagesize).then(data => {
            ...
            delBranch(target){
                this.$confirm(`是否 删除 部门 [ ${target.name} ]?`, '提示', {
                    ...
                    this.$apibranch.delete(target.branchid).then( data => {
            ...
            handleStatusSwitch(target, new_state){
                ...
                this.$confirm(`是否 ${action} 部门 [ ${target.name} ]?`, '提示', {
                    ...
                    if(isEnable){
                        this.$apibranch.enable(branchid).then( data => {
                            target.status = true
                            this.$message({
                                type: 'success',
                                message: action + '成功!'
                        ...
                        this.$apibranch.disable(branchid).then( data => {
                            target.status = false
                            this.$message({
                                type: 'success',
                                message: action + '成功!'
